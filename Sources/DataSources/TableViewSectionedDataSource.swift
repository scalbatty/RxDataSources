...
open class RxTableViewSectionedDataSource<S: SectionModelType>
    ...
    fileprivate var _sectionModels: [SectionModelSnapshot] = []
    ...
    open func setItem(_ item: I, indexPath: IndexPath) {
        var section = self._sectionModels[indexPath.section]
        section.items[indexPath.item] = item
        self._sectionModels[indexPath.section] = section
    }

    open func modelAtIndexPath(_ indexPath: IndexPath) throws -> Any {
    ...
    open var titleForHeaderInSection: ((RxTableViewSectionedDataSource<S>, _ section: Int) -> String?)? {
        didSet {
            #if DEBUG
                ensureNotMutatedAfterBinding()
            #endif
    ...
    open var titleForFooterInSection: ((RxTableViewSectionedDataSource<S>, _ section: Int) -> String?)? {
        didSet {
            #if DEBUG
                ensureNotMutatedAfterBinding()
            #endif
    ...
    open var canEditRowAtIndexPath: ((RxTableViewSectionedDataSource<S>, _ indexPath: IndexPath) -> Bool)? {
        didSet {
            #if DEBUG
                ensureNotMutatedAfterBinding()
            #endif
    ...
    open var canMoveRowAtIndexPath: ((RxTableViewSectionedDataSource<S>, _ indexPath: IndexPath) -> Bool)? {
        didSet {
            #if DEBUG
                ensureNotMutatedAfterBinding()
            #endif
    ...
    #if os(iOS)
    open var sectionIndexTitles: ((RxTableViewSectionedDataSource<S>) -> [String]?)? {
        didSet {
            #if DEBUG
            ensureNotMutatedAfterBinding()
            #endif
    ...
    open var sectionForSectionIndexTitle:((RxTableViewSectionedDataSource<S>, _ title: String, _ index: Int) -> Int)? {
        didSet {
            #if DEBUG
            ensureNotMutatedAfterBinding()
            #endif
